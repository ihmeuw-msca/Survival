...
To use the code, we need a data frame with the following columns as listed `_here<https://github.com/ihmeuw-msca/Survival/blob/48a072a19544babfa204c443fccaa37d2babbc77/src/survival/age_group_extension.py#L31>_`:
